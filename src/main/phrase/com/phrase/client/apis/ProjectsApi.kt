...
import com.phrase.client.models.ProjectCreateParameters
import com.phrase.client.models.ProjectDetails
import com.phrase.client.models.ProjectUpdateParameters
...
class ProjectsApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun projectDelete(id: kotlin.String, xminusPhraseAppMinusOTP: kotlin.String?) : Unit {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun projectShow(id: kotlin.String, xminusPhraseAppMinusOTP: kotlin.String?) : ProjectDetails {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("X-PhraseApp-OTP" to xminusPhraseAppMinusOTP.toString())
        val localVariableConfig = RequestConfig(
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun projectUpdate(id: kotlin.String, projectUpdateParameters: ProjectUpdateParameters, xminusPhraseAppMinusOTP: kotlin.String?) : ProjectDetails {
        val localVariableBody: kotlin.Any? = projectUpdateParameters
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("X-PhraseApp-OTP" to xminusPhraseAppMinusOTP.toString())
        val localVariableConfig = RequestConfig(
            RequestMethod.PATCH,
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun projectsList(xminusPhraseAppMinusOTP: kotlin.String?, page: kotlin.Int?, perPage: kotlin.Int?) : kotlin.Array<Project> {
        val localVariableBody: kotlin.Any? = null
