...
import com.phrase.client.models.Tag
import com.phrase.client.models.TagCreateParameters
import com.phrase.client.models.TagWithStats
...
class TagsApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun tagCreate(projectId: kotlin.String, tagCreateParameters: TagCreateParameters, xminusPhraseAppMinusOTP: kotlin.String?) : TagWithStats {
        val localVariableBody: kotlin.Any? = tagCreateParameters
        ...
        val localVariableConfig = RequestConfig(
            RequestMethod.POST,
            "/projects/{project_id}/tags".replace("{"+"project_id"+"}", "$projectId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val localVarResponse = request<TagWithStats>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as TagWithStats
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun tagDelete(projectId: kotlin.String, name: kotlin.String, xminusPhraseAppMinusOTP: kotlin.String?, branch: kotlin.String?) : Unit {
        ...
        val localVariableConfig = RequestConfig(
            ...
            "/projects/{project_id}/tags/{name}".replace("{"+"project_id"+"}", "$projectId").replace("{"+"name"+"}", "$name"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun tagShow(projectId: kotlin.String, name: kotlin.String, xminusPhraseAppMinusOTP: kotlin.String?, branch: kotlin.String?) : TagWithStats {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (branch != null) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun tagsList(projectId: kotlin.String, xminusPhraseAppMinusOTP: kotlin.String?, page: kotlin.Int?, perPage: kotlin.Int?, branch: kotlin.String?) : kotlin.Array<Tag> {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (page != null) {
        ...
        val localVarResponse = request<kotlin.Array<Tag>>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as kotlin.Array<Tag>
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
