...
import com.phrase.client.models.BitbucketSync
import com.phrase.client.models.BitbucketSyncExportParameters
import com.phrase.client.models.BitbucketSyncExportResponse
import com.phrase.client.models.BitbucketSyncImportParameters
...
class BitbucketSyncApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    fun bitbucketSyncExport(id: kotlin.String, bitbucketSyncExportParameters: BitbucketSyncExportParameters, xminusPhraseAppMinusOTP: kotlin.String?) : BitbucketSyncExportResponse {
        val localVariableBody: kotlin.Any? = bitbucketSyncExportParameters
        ...
        val localVariableConfig = RequestConfig(
            RequestMethod.POST,
            "/bitbucket_syncs/{id}/export".replace("{"+"id"+"}", "$id"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val localVarResponse = request<BitbucketSyncExportResponse>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as BitbucketSyncExportResponse
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun bitbucketSyncImport(id: kotlin.String, bitbucketSyncImportParameters: BitbucketSyncImportParameters, xminusPhraseAppMinusOTP: kotlin.String?) : Unit {
        val localVariableBody: kotlin.Any? = bitbucketSyncImportParameters
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("X-PhraseApp-OTP" to xminusPhraseAppMinusOTP.toString())
        val localVariableConfig = RequestConfig(
            RequestMethod.POST,
            "/bitbucket_syncs/{id}/import".replace("{"+"id"+"}", "$id"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
    ...
    * @return kotlin.Array<BitbucketSync>
    * @throws UnsupportedOperationException If the API returns an informational or redirection response
    * @throws ClientException If the API returns a client error response
    * @throws ServerException If the API returns a server error response
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun bitbucketSyncsList(xminusPhraseAppMinusOTP: kotlin.String?, accountId: kotlin.String?) : kotlin.Array<BitbucketSync> {
        ...
        val localVarResponse = request<kotlin.Array<BitbucketSync>>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as kotlin.Array<BitbucketSync>
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
