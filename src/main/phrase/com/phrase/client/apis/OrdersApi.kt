...
import com.phrase.client.models.OrderConfirmParameters
import com.phrase.client.models.OrderCreateParameters
import com.phrase.client.models.TranslationOrder
...
class OrdersApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun orderConfirm(projectId: kotlin.String, id: kotlin.String, orderConfirmParameters: OrderConfirmParameters, xminusPhraseAppMinusOTP: kotlin.String?) : TranslationOrder {
        val localVariableBody: kotlin.Any? = orderConfirmParameters
        ...
        val localVariableConfig = RequestConfig(
            RequestMethod.PATCH,
            "/projects/{project_id}/orders/{id}/confirm".replace("{"+"project_id"+"}", "$projectId").replace("{"+"id"+"}", "$id"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val localVarResponse = request<TranslationOrder>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as TranslationOrder
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun orderCreate(projectId: kotlin.String, orderCreateParameters: OrderCreateParameters, xminusPhraseAppMinusOTP: kotlin.String?) : TranslationOrder {
        val localVariableBody: kotlin.Any? = orderCreateParameters
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("X-PhraseApp-OTP" to xminusPhraseAppMinusOTP.toString())
        val localVariableConfig = RequestConfig(
            RequestMethod.POST,
            "/projects/{project_id}/orders".replace("{"+"project_id"+"}", "$projectId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val localVarResponse = request<TranslationOrder>(
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun orderDelete(projectId: kotlin.String, id: kotlin.String, xminusPhraseAppMinusOTP: kotlin.String?, branch: kotlin.String?) : Unit {
        ...
        val localVariableConfig = RequestConfig(
            ...
            "/projects/{project_id}/orders/{id}".replace("{"+"project_id"+"}", "$projectId").replace("{"+"id"+"}", "$id"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun orderShow(projectId: kotlin.String, id: kotlin.String, xminusPhraseAppMinusOTP: kotlin.String?, branch: kotlin.String?) : TranslationOrder {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (branch != null) {
    ...
    * @param branch specify the branch to use (optional)
    * @return kotlin.Array<TranslationOrder>
    * @throws UnsupportedOperationException If the API returns an informational or redirection response
    * @throws ClientException If the API returns a client error response
    * @throws ServerException If the API returns a server error response
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun ordersList(projectId: kotlin.String, xminusPhraseAppMinusOTP: kotlin.String?, page: kotlin.Int?, perPage: kotlin.Int?, branch: kotlin.String?) : kotlin.Array<TranslationOrder> {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (page != null) {
        ...
        val localVarResponse = request<kotlin.Array<TranslationOrder>>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as kotlin.Array<TranslationOrder>
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
