...
import com.phrase.client.models.Webhook
import com.phrase.client.models.WebhookCreateParameters
import com.phrase.client.models.WebhookUpdateParameters
...
class WebhooksApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun webhookCreate(projectId: kotlin.String, webhookCreateParameters: WebhookCreateParameters, xminusPhraseAppMinusOTP: kotlin.String?) : Webhook {
        val localVariableBody: kotlin.Any? = webhookCreateParameters
        ...
        val localVariableConfig = RequestConfig(
            RequestMethod.POST,
            "/projects/{project_id}/webhooks".replace("{"+"project_id"+"}", "$projectId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val localVarResponse = request<Webhook>(
            localVariableConfig,
            localVariableBody
        )
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun webhookDelete(projectId: kotlin.String, id: kotlin.String, xminusPhraseAppMinusOTP: kotlin.String?) : Unit {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("X-PhraseApp-OTP" to xminusPhraseAppMinusOTP.toString())
        val localVariableConfig = RequestConfig(
            RequestMethod.DELETE,
            "/projects/{project_id}/webhooks/{id}".replace("{"+"project_id"+"}", "$projectId").replace("{"+"id"+"}", "$id"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun webhookShow(projectId: kotlin.String, id: kotlin.String, xminusPhraseAppMinusOTP: kotlin.String?) : Webhook {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("X-PhraseApp-OTP" to xminusPhraseAppMinusOTP.toString())
        val localVariableConfig = RequestConfig(
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun webhookTest(projectId: kotlin.String, id: kotlin.String, xminusPhraseAppMinusOTP: kotlin.String?) : Unit {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("X-PhraseApp-OTP" to xminusPhraseAppMinusOTP.toString())
        val localVariableConfig = RequestConfig(
            RequestMethod.POST,
            "/projects/{project_id}/webhooks/{id}/test".replace("{"+"project_id"+"}", "$projectId").replace("{"+"id"+"}", "$id"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val localVarResponse = request<Any?>(
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun webhookUpdate(projectId: kotlin.String, id: kotlin.String, webhookUpdateParameters: WebhookUpdateParameters, xminusPhraseAppMinusOTP: kotlin.String?) : Webhook {
        val localVariableBody: kotlin.Any? = webhookUpdateParameters
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("X-PhraseApp-OTP" to xminusPhraseAppMinusOTP.toString())
        val localVariableConfig = RequestConfig(
            RequestMethod.PATCH,
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun webhooksList(projectId: kotlin.String, xminusPhraseAppMinusOTP: kotlin.String?, page: kotlin.Int?, perPage: kotlin.Int?) : kotlin.Array<Webhook> {
        val localVariableBody: kotlin.Any? = null
        ...
        val localVarResponse = request<kotlin.Array<Webhook>>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as kotlin.Array<Webhook>
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
