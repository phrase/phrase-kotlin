...
import com.phrase.client.models.ScreenshotMarker
import com.phrase.client.models.ScreenshotMarkerCreateParameters
import com.phrase.client.models.ScreenshotMarkerUpdateParameters
...
class ScreenshotMarkersApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    fun screenshotMarkerCreate(projectId: kotlin.String, screenshotId: kotlin.String, screenshotMarkerCreateParameters: ScreenshotMarkerCreateParameters, xminusPhraseAppMinusOTP: kotlin.String?) : ScreenshotMarker {
        val localVariableBody: kotlin.Any? = screenshotMarkerCreateParameters
        ...
        val localVariableConfig = RequestConfig(
            RequestMethod.POST,
            "/projects/{project_id}/screenshots/{screenshot_id}/markers".replace("{"+"project_id"+"}", "$projectId").replace("{"+"screenshot_id"+"}", "$screenshotId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val localVarResponse = request<ScreenshotMarker>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as ScreenshotMarker
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun screenshotMarkerDelete(projectId: kotlin.String, screenshotId: kotlin.String, xminusPhraseAppMinusOTP: kotlin.String?) : Unit {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun screenshotMarkerShow(projectId: kotlin.String, screenshotId: kotlin.String, id: kotlin.String, xminusPhraseAppMinusOTP: kotlin.String?) : ScreenshotMarker {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("X-PhraseApp-OTP" to xminusPhraseAppMinusOTP.toString())
        val localVariableConfig = RequestConfig(
            RequestMethod.GET,
            "/projects/{project_id}/screenshots/{screenshot_id}/markers/{id}".replace("{"+"project_id"+"}", "$projectId").replace("{"+"screenshot_id"+"}", "$screenshotId").replace("{"+"id"+"}", "$id"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val localVarResponse = request<ScreenshotMarker>(
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun screenshotMarkerUpdate(projectId: kotlin.String, screenshotId: kotlin.String, screenshotMarkerUpdateParameters: ScreenshotMarkerUpdateParameters, xminusPhraseAppMinusOTP: kotlin.String?) : ScreenshotMarker {
        val localVariableBody: kotlin.Any? = screenshotMarkerUpdateParameters
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("X-PhraseApp-OTP" to xminusPhraseAppMinusOTP.toString())
        val localVariableConfig = RequestConfig(
            RequestMethod.PATCH,
    ...
    * @return kotlin.Array<ScreenshotMarker>
    * @throws UnsupportedOperationException If the API returns an informational or redirection response
    * @throws ClientException If the API returns a client error response
    * @throws ServerException If the API returns a server error response
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun screenshotMarkersList(projectId: kotlin.String, id: kotlin.String, xminusPhraseAppMinusOTP: kotlin.String?, page: kotlin.Int?, perPage: kotlin.Int?) : kotlin.Array<ScreenshotMarker> {
        val localVariableBody: kotlin.Any? = null
        ...
        val localVariableConfig = RequestConfig(
            RequestMethod.GET,
            "/projects/{project_id}/screenshots/{id}/markers".replace("{"+"project_id"+"}", "$projectId").replace("{"+"id"+"}", "$id"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val localVarResponse = request<kotlin.Array<ScreenshotMarker>>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as kotlin.Array<ScreenshotMarker>
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
