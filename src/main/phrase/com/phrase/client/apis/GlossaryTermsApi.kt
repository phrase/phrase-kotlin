...
import com.phrase.client.models.GlossaryTerm
import com.phrase.client.models.GlossaryTermCreateParameters
import com.phrase.client.models.GlossaryTermUpdateParameters
...
class GlossaryTermsApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    fun glossaryTermCreate(accountId: kotlin.String, glossaryId: kotlin.String, glossaryTermCreateParameters: GlossaryTermCreateParameters, xminusPhraseAppMinusOTP: kotlin.String?) : GlossaryTerm {
        val localVariableBody: kotlin.Any? = glossaryTermCreateParameters
        ...
        val localVariableConfig = RequestConfig(
            RequestMethod.POST,
            "/accounts/{account_id}/glossaries/{glossary_id}/terms".replace("{"+"account_id"+"}", "$accountId").replace("{"+"glossary_id"+"}", "$glossaryId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val localVarResponse = request<GlossaryTerm>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as GlossaryTerm
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun glossaryTermDelete(accountId: kotlin.String, glossaryId: kotlin.String, id: kotlin.String, xminusPhraseAppMinusOTP: kotlin.String?) : Unit {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("X-PhraseApp-OTP" to xminusPhraseAppMinusOTP.toString())
        val localVariableConfig = RequestConfig(
            RequestMethod.DELETE,
            "/accounts/{account_id}/glossaries/{glossary_id}/terms/{id}".replace("{"+"account_id"+"}", "$accountId").replace("{"+"glossary_id"+"}", "$glossaryId").replace("{"+"id"+"}", "$id"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun glossaryTermShow(accountId: kotlin.String, glossaryId: kotlin.String, id: kotlin.String, xminusPhraseAppMinusOTP: kotlin.String?) : GlossaryTerm {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("X-PhraseApp-OTP" to xminusPhraseAppMinusOTP.toString())
        val localVariableConfig = RequestConfig(
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun glossaryTermUpdate(accountId: kotlin.String, glossaryId: kotlin.String, id: kotlin.String, glossaryTermUpdateParameters: GlossaryTermUpdateParameters, xminusPhraseAppMinusOTP: kotlin.String?) : GlossaryTerm {
        val localVariableBody: kotlin.Any? = glossaryTermUpdateParameters
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("X-PhraseApp-OTP" to xminusPhraseAppMinusOTP.toString())
        val localVariableConfig = RequestConfig(
            RequestMethod.PATCH,
    ...
    * @return kotlin.Array<GlossaryTerm>
    * @throws UnsupportedOperationException If the API returns an informational or redirection response
    * @throws ClientException If the API returns a client error response
    * @throws ServerException If the API returns a server error response
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun glossaryTermsList(accountId: kotlin.String, glossaryId: kotlin.String, xminusPhraseAppMinusOTP: kotlin.String?, page: kotlin.Int?, perPage: kotlin.Int?) : kotlin.Array<GlossaryTerm> {
        val localVariableBody: kotlin.Any? = null
        ...
        val localVarResponse = request<kotlin.Array<GlossaryTerm>>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as kotlin.Array<GlossaryTerm>
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
