...
import com.phrase.client.models.Styleguide
import com.phrase.client.models.StyleguideCreateParameters
import com.phrase.client.models.StyleguideDetails
import com.phrase.client.models.StyleguideUpdateParameters
...
class StyleGuidesApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    fun styleguideCreate(projectId: kotlin.String, styleguideCreateParameters: StyleguideCreateParameters, xminusPhraseAppMinusOTP: kotlin.String?) : Unit {
        ...
        val localVariableConfig = RequestConfig(
            RequestMethod.POST,
            "/projects/{project_id}/styleguides".replace("{"+"project_id"+"}", "$projectId"),
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun styleguideDelete(projectId: kotlin.String, id: kotlin.String, xminusPhraseAppMinusOTP: kotlin.String?) : Unit {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("X-PhraseApp-OTP" to xminusPhraseAppMinusOTP.toString())
        val localVariableConfig = RequestConfig(
            RequestMethod.DELETE,
            "/projects/{project_id}/styleguides/{id}".replace("{"+"project_id"+"}", "$projectId").replace("{"+"id"+"}", "$id"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val localVarResponse = request<Any?>(
    ...
    */
    ...
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun styleguideShow(projectId: kotlin.String, id: kotlin.String, xminusPhraseAppMinusOTP: kotlin.String?) : StyleguideDetails {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("X-PhraseApp-OTP" to xminusPhraseAppMinusOTP.toString())
        val localVariableConfig = RequestConfig(
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun styleguideUpdate(projectId: kotlin.String, id: kotlin.String, styleguideUpdateParameters: StyleguideUpdateParameters, xminusPhraseAppMinusOTP: kotlin.String?) : StyleguideDetails {
        val localVariableBody: kotlin.Any? = styleguideUpdateParameters
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("X-PhraseApp-OTP" to xminusPhraseAppMinusOTP.toString())
        val localVariableConfig = RequestConfig(
            RequestMethod.PATCH,
    ...
    * @return kotlin.Array<Styleguide>
    * @throws UnsupportedOperationException If the API returns an informational or redirection response
    * @throws ClientException If the API returns a client error response
    * @throws ServerException If the API returns a server error response
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun styleguidesList(projectId: kotlin.String, xminusPhraseAppMinusOTP: kotlin.String?, page: kotlin.Int?, perPage: kotlin.Int?) : kotlin.Array<Styleguide> {
        val localVariableBody: kotlin.Any? = null
        ...
        val localVarResponse = request<kotlin.Array<Styleguide>>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as kotlin.Array<Styleguide>
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
