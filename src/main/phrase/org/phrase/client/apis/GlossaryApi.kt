...
import org.phrase.client.models.Glossary
import org.phrase.client.models.GlossaryCreateParameters
import org.phrase.client.models.GlossaryUpdateParameters
...
class GlossaryApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun glossaryCreate(accountId: kotlin.String, glossaryCreateParameters: GlossaryCreateParameters, xminusPhraseAppMinusOTP: kotlin.String?) : Unit {
