...
import org.phrase.client.models.Invitation
import org.phrase.client.models.InvitationCreateParameters
import org.phrase.client.models.InvitationUpdateParameters
...
class InvitationsApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    fun invitationCreate(accountId: kotlin.String, invitationCreateParameters: InvitationCreateParameters, xminusPhraseAppMinusOTP: kotlin.String?) : Unit {
        ...
        val localVariableConfig = RequestConfig(
            RequestMethod.POST,
            "/accounts/{account_id}/invitations".replace("{"+"account_id"+"}", "$accountId"),
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun invitationDelete(accountId: kotlin.String, id: kotlin.String, xminusPhraseAppMinusOTP: kotlin.String?) : Unit {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("X-PhraseApp-OTP" to xminusPhraseAppMinusOTP.toString())
        val localVariableConfig = RequestConfig(
            RequestMethod.DELETE,
            "/accounts/{account_id}/invitations/{id}".replace("{"+"account_id"+"}", "$accountId").replace("{"+"id"+"}", "$id"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val localVarResponse = request<Any?>(
    ...
    */
    ...
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun invitationResend(accountId: kotlin.String, id: kotlin.String, xminusPhraseAppMinusOTP: kotlin.String?) : Invitation {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("X-PhraseApp-OTP" to xminusPhraseAppMinusOTP.toString())
        val localVariableConfig = RequestConfig(
            RequestMethod.POST,
            "/accounts/{account_id}/invitations/{id}/resend".replace("{"+"account_id"+"}", "$accountId").replace("{"+"id"+"}", "$id"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun invitationShow(accountId: kotlin.String, id: kotlin.String, xminusPhraseAppMinusOTP: kotlin.String?) : Invitation {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("X-PhraseApp-OTP" to xminusPhraseAppMinusOTP.toString())
        val localVariableConfig = RequestConfig(
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun invitationUpdate(accountId: kotlin.String, id: kotlin.String, invitationUpdateParameters: InvitationUpdateParameters, xminusPhraseAppMinusOTP: kotlin.String?) : Invitation {
        val localVariableBody: kotlin.Any? = invitationUpdateParameters
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("X-PhraseApp-OTP" to xminusPhraseAppMinusOTP.toString())
        val localVariableConfig = RequestConfig(
            RequestMethod.PATCH,
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun invitationsList(accountId: kotlin.String, xminusPhraseAppMinusOTP: kotlin.String?, page: kotlin.Int?, perPage: kotlin.Int?) : kotlin.Array<Invitation> {
        val localVariableBody: kotlin.Any? = null
        ...
        val localVarResponse = request<kotlin.Array<Invitation>>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as kotlin.Array<Invitation>
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
