...
import org.phrase.client.models.Screenshot
import org.phrase.client.models.ScreenshotCreateParameters
import org.phrase.client.models.ScreenshotUpdateParameters
...
class ScreenshotsApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun screenshotCreate(projectId: kotlin.String, screenshotCreateParameters: ScreenshotCreateParameters, xminusPhraseAppMinusOTP: kotlin.String?) : Unit {
