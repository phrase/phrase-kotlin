...
import org.phrase.client.models.GlossaryTermTranslation
import org.phrase.client.models.GlossaryTermTranslationCreateParameters
import org.phrase.client.models.GlossaryTermTranslationUpdateParameters
...
class GlossaryTermTranslationsApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    fun glossaryTermTranslationCreate(accountId: kotlin.String, glossaryId: kotlin.String, termId: kotlin.String, glossaryTermTranslationCreateParameters: GlossaryTermTranslationCreateParameters, xminusPhraseAppMinusOTP: kotlin.String?) : Unit {
        ...
        val localVariableConfig = RequestConfig(
            RequestMethod.POST,
            "/accounts/{account_id}/glossaries/{glossary_id}/terms/{term_id}/translations".replace("{"+"account_id"+"}", "$accountId").replace("{"+"glossary_id"+"}", "$glossaryId").replace("{"+"term_id"+"}", "$termId"),
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun glossaryTermTranslationDelete(accountId: kotlin.String, glossaryId: kotlin.String, termId: kotlin.String, id: kotlin.String, xminusPhraseAppMinusOTP: kotlin.String?) : Unit {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("X-PhraseApp-OTP" to xminusPhraseAppMinusOTP.toString())
        val localVariableConfig = RequestConfig(
            RequestMethod.DELETE,
            "/accounts/{account_id}/glossaries/{glossary_id}/terms/{term_id}/translations/{id}".replace("{"+"account_id"+"}", "$accountId").replace("{"+"glossary_id"+"}", "$glossaryId").replace("{"+"term_id"+"}", "$termId").replace("{"+"id"+"}", "$id"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val localVarResponse = request<Any?>(
    ...
    */
    ...
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun glossaryTermTranslationUpdate(accountId: kotlin.String, glossaryId: kotlin.String, termId: kotlin.String, id: kotlin.String, glossaryTermTranslationUpdateParameters: GlossaryTermTranslationUpdateParameters, xminusPhraseAppMinusOTP: kotlin.String?) : GlossaryTermTranslation {
        val localVariableBody: kotlin.Any? = glossaryTermTranslationUpdateParameters
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("X-PhraseApp-OTP" to xminusPhraseAppMinusOTP.toString())
        val localVariableConfig = RequestConfig(
            RequestMethod.PATCH,
