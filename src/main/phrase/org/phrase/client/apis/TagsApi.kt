...
import org.phrase.client.models.Tag
import org.phrase.client.models.TagCreateParameters
import org.phrase.client.models.TagWithStats
...
class TagsApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun tagCreate(projectId: kotlin.String, tagCreateParameters: TagCreateParameters, xminusPhraseAppMinusOTP: kotlin.String?) : Unit {
