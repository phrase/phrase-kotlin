...
import org.phrase.client.models.UploadCreateParameters
...
class UploadsApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun uploadCreate(projectId: kotlin.String, uploadCreateParameters: UploadCreateParameters, xminusPhraseAppMinusOTP: kotlin.String?) : Unit {
    ...
    */
    ...
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun uploadShow(projectId: kotlin.String, id: kotlin.String, xminusPhraseAppMinusOTP: kotlin.String?, branch: kotlin.String?) : Upload {
        ...
        val localVariableConfig = RequestConfig(
            RequestMethod.GET,
            "/projects/{project_id}/uploads/{id}".replace("{"+"project_id"+"}", "$projectId").replace("{"+"id"+"}", "$id"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun uploadsList(projectId: kotlin.String, xminusPhraseAppMinusOTP: kotlin.String?, page: kotlin.Int?, perPage: kotlin.Int?, branch: kotlin.String?) : kotlin.Array<Upload> {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (page != null) {
