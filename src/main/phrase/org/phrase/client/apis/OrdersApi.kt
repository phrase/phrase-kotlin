...
import org.phrase.client.models.OrderConfirmParameters
import org.phrase.client.models.OrderCreateParameters
import org.phrase.client.models.TranslationOrder
...
class OrdersApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun orderCreate(projectId: kotlin.String, orderCreateParameters: OrderCreateParameters, xminusPhraseAppMinusOTP: kotlin.String?) : Unit {
