...
import org.phrase.client.models.Member
import org.phrase.client.models.MemberUpdateParameters
...
class MembersApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    fun memberDelete(accountId: kotlin.String, id: kotlin.String, xminusPhraseAppMinusOTP: kotlin.String?) : Unit {
        ...
        val localVariableConfig = RequestConfig(
            ...
            "/accounts/{account_id}/members/{id}".replace("{"+"account_id"+"}", "$accountId").replace("{"+"id"+"}", "$id"),
    ...
    */
    ...
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun memberShow(accountId: kotlin.String, id: kotlin.String, xminusPhraseAppMinusOTP: kotlin.String?) : Member {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("X-PhraseApp-OTP" to xminusPhraseAppMinusOTP.toString())
        val localVariableConfig = RequestConfig(
        ...
        val localVarResponse = request<Member>(
            localVariableConfig,
            localVariableBody
        )
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun memberUpdate(accountId: kotlin.String, id: kotlin.String, memberUpdateParameters: MemberUpdateParameters, xminusPhraseAppMinusOTP: kotlin.String?) : Member {
        val localVariableBody: kotlin.Any? = memberUpdateParameters
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("X-PhraseApp-OTP" to xminusPhraseAppMinusOTP.toString())
        val localVariableConfig = RequestConfig(
            RequestMethod.PATCH,
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun membersList(accountId: kotlin.String, xminusPhraseAppMinusOTP: kotlin.String?, page: kotlin.Int?, perPage: kotlin.Int?) : kotlin.Array<Member> {
        val localVariableBody: kotlin.Any? = null
        ...
        val localVariableConfig = RequestConfig(
            RequestMethod.GET,
            "/accounts/{account_id}/members".replace("{"+"account_id"+"}", "$accountId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val localVarResponse = request<kotlin.Array<Member>>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as kotlin.Array<Member>
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
